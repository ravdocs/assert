...
describe('Assert.deepNarrowKind()', function() {

	it('should support kind \'undefined\'', function(done) {
		var val;
		var kind = 'undefined';
		try {
			Assert.deepNarrowKind('val', val, kind);
		} catch (err) {
	...
	it('should not throw error for Array structure where the expected contains most but not all of the content of the actual', function(done) {
	...
	it('should not throw error for Object structure where the expected contains most but not all of the keys and values of the actual', function(done) {
	...
	it('should not throw error for Map structure where the expected contains most but not all of the keys and values of the actual', function(done) {
