...
describe('Assert.deepNarrowStrictEqual()', function() {

	it('should not throw error for 2 undefined values', function(done) {
		var val1;
		var val2;
		try {
			Assert.deepNarrowStrictEqual('val1', val1, val2);
		} catch (err) {
	...
	it('should not throw error for 2 Array objects where the second contains most but not all of the content of the first', function(done) {
	...
	it('should not throw error for 2 Objects where the second contains most but not all of the keys and values of the first', function(done) {
	...
	it('should not throw error for 2 Map objects where the second contains most but not all of the keys and values of the first', function(done) {
	...
	it('should not throw error for 2 Set objects where the second contains most but not all of the values of the first', function(done) {
